...
const UpdateAccount = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        await post([
            { key: "action", type: "string", value: "updateAccount" },
    ...
    return (
        <Form onSubmit={handleSubmit}>
            ...
            <hr/>
            <FormControl placeholder="Название организации" onChange={(e) => setName(e.target.value)} />
            <hr/>
            <FormControl placeholder="Регион" onChange={(e) => setRegion(e.target.value)} />
            <hr/>
            <FormControl placeholder="Описание" onChange={(e) => setDescription(e.target.value)} />
            <hr/>
            <FormControl placeholder="Адрес сотрудника" onChange={(e) => setUserWallet(e.target.value)} />
            <hr/>
            <FormControl placeholder="ФИО сотрудника" onChange={(e) => setFullName(e.target.value)} />
            <hr/>
            <FormControl placeholder="Контактные данные" onChange={(e) => setContact(e.target.value)} />
            <hr/>
            <FormControl placeholder="Должность" onChange={(e) => setPosition(e.target.value)} />
